...
public class SimpleTest extends BaseTest {
    ...
    public void run() throws IOException {
        ...
        User user = session.selectOne("com.t2t.examples.service.UserMapper.get", 1);
        System.out.println(user.getName() + "," + user.getAge());

        System.out.println("2. 执行查询返回列表");
        List<User> list = session.selectList("com.t2t.examples.service.UserMapper.list");
    ...
    public SqlSessionFactory getFactory1() throws IOException {
    ...
    public SqlSessionFactory getFactory2() throws IOException {
